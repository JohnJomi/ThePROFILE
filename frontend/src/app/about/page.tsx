...
export default function AboutPage() {
  return (
    <>
      ...
      <Section animated={false} className="bg-transparent text-text-primary">
        <Container size="default" className="flex flex-col gap-12">
          <SectionHeader
            ...
            descriptionClassName="max-w-3xl text-text-primary/85"
            className="mb-0"
          />
            ...
            <RevealGroup slow className="grid gap-6">
              {[
                ...
                <Card key={item.title} animated hoverable className="flex flex-col gap-4">
                  ...
                  <p className="text-sm leading-7 text-text-primary/85">{item.description}</p>
                </Card>
              ))}
            </RevealGroup>
          ...
          <RevealGroup className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {interests.map((interest) => (
              <Card key={interest.label} animated hoverable className="flex items-center gap-4">
                ...
                <p className="text-sm uppercase tracking-[0.16em] text-text-primary/90">
                  {interest.label}
                </p>
              </Card>
            ))}
